...
static struct emitter emitters[] = {
	...
	DECL_EMITTER(INSN_MOVSD_MEMLOCAL_XMM, emit_mov_64_memlocal_xmm),
	...
	DECL_EMITTER(INSN_MOVSD_XMM_XMM, emit_mov_64_xmm_xmm),
	...
	DECL_EMITTER(INSN_MOVSS_MEMLOCAL_XMM, emit_mov_memlocal_xmm),
	...
	DECL_EMITTER(INSN_MOVSS_XMM_XMM, emit_mov_xmm_xmm),
