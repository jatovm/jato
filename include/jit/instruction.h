...
enum insn_type {
	...
	INSN_AND_MEMBASE_REG	= DEFINE_INSN_TYPE_2(OPC_AND,  OPERAND_MEMBASE,   OPERAND_REGISTER),
	...
	INSN_OR_MEMBASE_REG	= DEFINE_INSN_TYPE_2(OPC_OR,   OPERAND_MEMBASE,   OPERAND_REGISTER),
	...
	INSN_XOR_MEMBASE_REG	= DEFINE_INSN_TYPE_2(OPC_XOR,  OPERAND_MEMBASE,   OPERAND_REGISTER),
};
