			   ...
			   struct statement *stmt, struct operand_stack *stack)
{
	...
	stmt->operand.value = code[0]-OPC_ICONST_0;
}
			   ...
			   struct statement *stmt, struct operand_stack *stack)
{
	...
	stmt->operand.value = code[0]-OPC_LCONST_0;
}
			   ...
			   struct statement *stmt, struct operand_stack *stack)
{
	...
	stmt->operand.fvalue = code[0]-OPC_FCONST_0;
}
			   ...
			   struct statement *stmt, struct operand_stack *stack)
{
	...
	stmt->operand.fvalue = code[0]-OPC_DCONST_0;
}
