 ...
 */
static unsigned char tableswitch[36] = {
...
void test_convert_tableswitch_bbs()
{
	...
	struct vm_method method = {
		.code_attribute.code = tableswitch,
		.code_attribute.code_length = ARRAY_SIZE(tableswitch),
		.method = &method_info,
	};
