...
static struct vm_native natives[] = {
	...
	DEFINE_NATIVE("java/lang/reflect/Field", "getShort", native_field_get_short),
	DEFINE_NATIVE("java/lang/reflect/Field", "getFloat", native_field_get_float),
	DEFINE_NATIVE("java/lang/reflect/Field", "getDouble", native_field_get_double),
	DEFINE_NATIVE("java/lang/reflect/Field", "getChar", native_field_get_char),
	DEFINE_NATIVE("java/lang/reflect/Field", "getByte", native_field_get_byte),
	DEFINE_NATIVE("java/lang/reflect/Field", "getBoolean", native_field_get_boolean),
	...
	DEFINE_NATIVE("java/lang/reflect/VMField", "getShort", native_field_get_short),
	DEFINE_NATIVE("java/lang/reflect/VMField", "getFloat", native_field_get_float),
	DEFINE_NATIVE("java/lang/reflect/VMField", "getDouble", native_field_get_double),
	DEFINE_NATIVE("java/lang/reflect/VMField", "getChar", native_field_get_char),
	DEFINE_NATIVE("java/lang/reflect/VMField", "getByte", native_field_get_byte),
	DEFINE_NATIVE("java/lang/reflect/VMField", "getBoolean", native_field_get_boolean),
